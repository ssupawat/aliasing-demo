...
(function (global) {
  ...
  var strings = {
    ...
    th: {
      'page.title': 'สัญญาณแฝง (Aliasing) ในการสุ่มตัวอย่าง — เดโมทฤษฎีบทไนควิสต์',
      'page.description': 'เดโมแบบโต้ตอบของทฤษฎีบทการสุ่มตัวอย่างและปรากฏการณ์สัญญาณแฝง (aliasing) ปรับความถี่สัญญาณและอัตราการสุ่มตัวอย่าง เพื่อดูว่าคลื่นพับกลับกลายเป็นความถี่ต่ำที่ผิดไปจากความจริงเมื่อใด',
      'hero.kicker': 'การประมวลผลสัญญาณ',
      'hero.title': 'สัญญาณแฝงในการสุ่มตัวอย่าง',
      'hero.lede': 'เมื่ออัตราการสุ่มตัวอย่างต่ำกว่าสองเท่าของความถี่สัญญาณ &mdash; ซึ่งก็คืออัตราไนควิสต์ &mdash; จุดตัวอย่างที่ได้จะแยกไม่ออกจากจุดตัวอย่างของคลื่นอีกลูกหนึ่งที่มีความถี่ต่ำกว่า หน้านี้สาธิตปรากฏการณ์ดังกล่าวโดยตรง',
      'lang.group': 'ภาษา',
      'lang.en': 'EN',
      'lang.th': 'ไทย',
      'lang.en.title': 'Read this page in English',
      ...
      'status.ok': 'ไม่เกิดสัญญาณแฝง — สร้างสัญญาณกลับคืนได้ถูกต้อง',
      'status.aliased': 'เกิดสัญญาณแฝง — ปรากฏเป็น {alias} Hz แทนที่จะเป็น {signal} Hz',
      'legend.signal': 'สัญญาณจริง',
      'legend.samples': 'จุดตัวอย่าง',
      ...
      'canvas.aria.aliased': 'เกิดสัญญาณแฝงที่ {alias} เฮิรตซ์',
      'canvas.aria.clean': 'ไม่เกิดสัญญาณแฝง',
      'ref.nyquist.title': 'เงื่อนไขไนควิสต์',
      'ref.nyquist.p1': 'สำหรับสัญญาณที่จำกัดแถบความถี่ไว้ที่ความถี่สูงสุด <span class="mono">f_max</span> การสร้างสัญญาณกลับคืนจากจุดตัวอย่างได้อย่างถูกต้องต้องใช้อัตราการสุ่มตัวอย่าง <span class="mono">f_s &gt; 2&middot;f_max</span> ครึ่งหนึ่งของอัตราการสุ่มตัวอย่าง คือ <span class="mono">f_s / 2</span> เรียกว่าความถี่ไนควิสต์ ซึ่งเป็นความถี่สูงสุดที่แทนค่าได้โดยไม่กำกวม',
      ...
      'ex.audio.term': 'เสียง',
      'ex.audio.body': 'ตัวแปลงสัญญาณดิจิทัลเป็นแอนะล็อกสุ่มตัวอย่างที่อัตราสูงกว่าย่านที่หูได้ยิน แต่ความถี่ที่สูงเกินขีดจำกัดไนควิสต์จะพับกลับลงมาเป็นสิ่งแปลกปลอมที่ได้ยินได้ หากไม่ถูกกรองออกก่อนด้วยวงจรกรองป้องกันสัญญาณแฝงแบบแอนะล็อก',
      'ex.video.term': 'วิดีโอ',
      'ex.video.body': 'ปรากฏการณ์ล้อเกวียน: ซี่ล้อดูเหมือนหมุนช้าลง หยุดนิ่ง หรือหมุนกลับทาง เมื่อความถี่การหมุนเข้าใกล้อัตราเฟรมของภาพ',
      ...
      'footer.text': 'หน้าเว็บแบบสแตติก — การคำนวณการสุ่มตัวอย่างและสัญญาณแฝงทั้งหมดทำงานในเบราว์เซอร์'
    }
  };
